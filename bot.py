...
async def cmd_start(msg: Message):
    ...
    msg2 = (
        ...
        "2 жыл бұрын тәуекел етіп бірден 1 000 дана блокнот шығардым.\n\n"
        "❌ Ақшаны қарызға алдым\n"
        "❌ Каспи магазин жоқ\n"
        "❌ Тәжірибе жоқ\n\n"
        "Казпочтада 2-3 сағат кезекте тұрып,\n"
        "әр клиентке өзім жауап беріп жібердім.\n\n"
        "Алғашқы 3 айда — 40-50 дана ғана сатылды 😅\n\n"
        "Бірақ анализ жасап, қателерімді таптым.\n"
        "Жаңа стратегия, жаңа воронка — және:\n\n"
        "✅ Қалған 950 данасы келесі 2 айда кетті\n"
        "✅ 2 000 дана тағы шығардым — 2 айда таусылды\n"
        "✅ Бүгін: 13 600+ сатылым · 50млн+ оборот"
    )
    ...
    msg3 = (
        ...
        "📌 Неге 3 айда 40-50 ғана сатылды — қандай қате жасадым\n"
        "📌 Не өзгерттім — өнімдерім қалай тез сатыла бастады\n"
        "📌 Контент, таргет — қандай видео сатты, бюджет қанша кетті\n"
        "📌 Типография, дизайн — баға, структура, өтімді дизайн\n"
        "📌 Каспи карточкасы — топқа шығу, отзыв жинау\n"
        "📌 ИП, Kaspi Pay, салық, жеткізу, буып-түю\n"
        "📌 Қателерім, тәжірибелерім, кеңестерім\n\n"
        "Бұл курс емес.\n"
        "Бұл — менің нақты жолым, нақты цифрлармен, нақты скриншоттармен.\n\n"
